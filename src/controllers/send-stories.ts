    ...
    try {
      ...
      // 3. Handle the general case of active and pinned stories.
        ...
        if (activeStories.length > 0) {
          ...
          const mappedActiveStories: MappedStoryItem[] =
            mapStories(activeStories);
        ...
        if (pinnedStories.length > 0) {
          const mappedPinnedStories: MappedStoryItem[] =
            mapStories(pinnedStories);
