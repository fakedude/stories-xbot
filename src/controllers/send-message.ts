...
import { NotifyAdminParams, UserInfo } from 'types'; // This is now correct!
...
export async function notifyAdmin({
  ...
  try {
    ...
    console.error('[notifyAdmin] Failed to send admin notification:', error);
  }
}
...
export async function sendErrorMessage({
  ...
  try {
    ...
    console.error(
      '[sendErrorMessage] failed to send error message to user:',
      error
    );
  }
}
